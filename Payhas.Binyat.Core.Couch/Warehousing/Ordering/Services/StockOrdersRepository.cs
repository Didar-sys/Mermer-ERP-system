...
// Type: Payhas.Binyat.Core.Couch.Warehousing.Ordering.Services.StockOrdersRepository
...
public class StockOrdersRepository(
  ICouchCluster cluster,
  IValidator<StockOrder> validator,
  ...
  IPatcher patcher,
  ILoginService loginService) : CouchRepositoryWithFacet<StockOrder>(patcher, cluster, validator, loginService, authorizer, changeListener, localChangesRepositoryService)
{
