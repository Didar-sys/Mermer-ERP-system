...
// Type: Payhas.Binyat.Core.Couch.CRM.Services.PartnerSlipsRepository
...
#nullable disable
namespace Payhas.Binyat.Core.Couch.CRM.Services;

public class PartnerSlipsRepository(
  ICouchCluster cluster,
  IValidator<PartnerSlip> validator,
  ...
  IPatcher patcher,
  ILoginService loginService) : CouchRepositoryWithFacet<PartnerSlip>(patcher, cluster, validator, loginService, authorizer, changeListener, localChangesRepositoryService)
{
