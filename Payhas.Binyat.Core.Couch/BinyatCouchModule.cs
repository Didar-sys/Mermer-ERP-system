...
// Type: Payhas.Binyat.Core.Couch.BinyatCouchModule
...
using Payhas.Binyat.Core.Couch.Authentication.Services;
...
#nullable disable
namespace Payhas.Binyat.Core.Couch;
...
public class BinyatCouchModule : BinyatCoreModule
{
  ...
  protected override void Load(ContainerBuilder builder)
  {
    ...
    builder.RegisterType<Payhas.Data.Patcher.Patcher>().As<IPatcher>();
    builder.RegisterType<ChangeHelper>().As<IChangeHelper>();
    Payhas.Data.Synchronizer.Core.Couch.Common.CouchCluster instance = new Payhas.Data.Synchronizer.Core.Couch.Common.CouchCluster();
    instance.Initialize(this._url, this._bucket, this._username, this._password);
    builder.RegisterInstance<Payhas.Data.Synchronizer.Core.Couch.Common.CouchCluster>(instance).As<Payhas.Data.Synchronizer.Core.Couch.Common.ICouchCluster>().SingleInstance();
  }
}
