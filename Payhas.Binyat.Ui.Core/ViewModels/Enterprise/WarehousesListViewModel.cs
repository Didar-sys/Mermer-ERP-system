...
// Type: Payhas.Binyat.Ui.Core.ViewModels.Enterprise.WarehousesListViewModel
...
public class WarehousesListViewModel : ListViewModel<Warehouse>
{
  public WarehousesListViewModel(
    ...
    : base(warehousesRepository, authorizer, messenger, navigationService, userInteractionService)
  {
