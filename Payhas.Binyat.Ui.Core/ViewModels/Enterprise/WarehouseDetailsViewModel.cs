...
// Type: Payhas.Binyat.Ui.Core.ViewModels.Enterprise.WarehouseDetailsViewModel
...
public class WarehouseDetailsViewModel : DetailsViewModel<Warehouse>
{
  private string[] _tagNames;

  public WarehouseDetailsViewModel(
    IRepositoryWithFacets<Warehouse> warehousesRepository,
    IListAuthorizer<Warehouse> authorizer,
    Reference<Office> officesReference,
    IMvxNavigationService navigationService,
    IUserInteractionService userInteractionService)
    : base((IRepository<Warehouse>) warehousesRepository, authorizer, navigationService, userInteractionService)
  {
  ...
  {
    WarehouseDetailsViewModel detailsViewModel = this;
    Dictionary<string, Dictionary<string, int>> facets = await ((IRepositoryWithFacets<Warehouse>) detailsViewModel.Repository).GetFacets("TagNames");
  ...
  {
    WarehouseDetailsViewModel detailsViewModel = this;
    Warehouse warehouse = detailsViewModel.Details;
    warehouse.OfficeId = await detailsViewModel.NavigationService.Navigate<ListViewModel<Office>, string, string>(detailsViewModel.Details.OfficeId);
