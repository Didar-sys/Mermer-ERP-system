...
// Type: Payhas.Binyat.Ui.Core.ViewModels.Transactions.StockTransactionDetailsViewModel`3
...
public class StockTransactionDetailsViewModel<T, TLine, TType>(
  ...
  IUserInteractionService userInteractionService) : StockTransactionDetailsViewModel<T, TLine>(copyCreate, repository, authorizer, configurator, loginService, stockSearcher, currencies, warehouses, stocksRepository, navigationService, codegentor, userInteractionService)
