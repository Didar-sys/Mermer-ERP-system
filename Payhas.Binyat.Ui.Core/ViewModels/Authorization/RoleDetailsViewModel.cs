...
// Type: Payhas.Binyat.Ui.Core.ViewModels.Authorization.RoleDetailsViewModel
  ...
  IUserInteractionService userInteractionService) : DetailsViewModel<Role>(repository, authorizer, navigationService, userInteractionService)
{
  ...
  protected override async Task PostLoad()
  {
    ...
    detailsViewModel.Actions = detailsViewModel.CreateActions<Payhas.Binyat.Authorization.Enums.Actions, AccessLevel>();
    detailsViewModel.ListActions = detailsViewModel.CreateActions<Payhas.Binyat.Authorization.Enums.ListActions, ListAccessLevel>();
    ...
    roleActionList.AddRange(detailsViewModel.CreateActions<Payhas.Binyat.Authorization.Enums.TransactionActions, TransactionAccessLevel>());
