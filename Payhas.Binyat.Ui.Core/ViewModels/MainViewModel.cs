...
// Type: Payhas.Binyat.Ui.Core.ViewModels.MainViewModel
...
using Payhas.Binyat.Ui.Core.ViewModels.CRM;
using Payhas.Binyat.Ui.Core.ViewModels.Finance;
using Payhas.Binyat.Ui.Core.ViewModels.Finance.Spending;
using Payhas.Binyat.Ui.Core.ViewModels.FundsManagement;
using Payhas.Binyat.Ui.Core.ViewModels.Reporting;
