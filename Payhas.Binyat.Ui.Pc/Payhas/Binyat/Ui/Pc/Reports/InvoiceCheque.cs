...
// Type: Payhas.Binyat.Ui.Pc.Reports.InvoiceCheque
...
public class InvoiceCheque : XtraReport
{
  ...
  public InvoiceCheque() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (InvoiceCheque));
    ...
    this.ReportHeader.Controls.AddRange(new XRControl[9]
    {
    ...
    this.ReportFooter.Controls.AddRange(new XRControl[23]
    {
    ...
    this.xrLabel5.Padding = new PaddingInfo(2, 2, 0, 0, 96f);
    this.xrLabel5.StyleName = "PropertyStyle";
