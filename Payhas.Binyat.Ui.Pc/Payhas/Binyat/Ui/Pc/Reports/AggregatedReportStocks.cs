...
// Type: Payhas.Binyat.Ui.Pc.Reports.AggregatedReportStocks
...
public class AggregatedReportStocks : XtraReport
{
  ...
  public AggregatedReportStocks() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (AggregatedReportStocks));
    ...
    this.objectDataSource1.DataSource = (object) typeof (StockBalanceAggregated);
