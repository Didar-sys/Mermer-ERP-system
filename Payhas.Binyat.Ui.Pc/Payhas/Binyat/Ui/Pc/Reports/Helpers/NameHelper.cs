...
// Type: Payhas.Binyat.Ui.Pc.Reports.Helpers.NameHelper
...
#nullable disable
namespace Payhas.Binyat.Ui.Pc.Reports.Helpers;
...
public class NameHelper
{
  ...
  private readonly Dictionary<string, Payhas.Binyat.FundsManagement.Models.Currency> _currencies;
  ...
  private readonly IRepository<Payhas.Binyat.FundsManagement.Models.Currency> _currenciesRepository;
  ...
  public NameHelper(
    ...
    IRepository<Payhas.Binyat.FundsManagement.Models.Currency> currenciesRepository,
    ...
    IRepository<Depository> depositoriesRepository)
  {
    ...
    this._currencies = new Dictionary<string, Payhas.Binyat.FundsManagement.Models.Currency>();
  ...
  {
    return (await this.Get<Payhas.Binyat.FundsManagement.Models.Currency>(currencyId, this._currencies, this._currenciesRepository)).Name;
  }
