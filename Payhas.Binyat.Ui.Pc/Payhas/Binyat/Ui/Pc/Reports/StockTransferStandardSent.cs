...
// Type: Payhas.Binyat.Ui.Pc.Reports.StockTransferStandardSent
...
public class StockTransferStandardSent : XtraReport
{
  ...
  public StockTransferStandardSent() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (StockTransferStandardSent));
    ...
    this.ReportHeader.Controls.AddRange(new XRControl[12]
    {
    ...
    this.xrTableCell5.Padding = new PaddingInfo(0, 0, 0, 0, 100f);
    this.xrTableCell5.StyleName = "LineStyle";
    ...
    this.xrTableCell16.Padding = new PaddingInfo(5, 0, 0, 0, 100f);
    ...
    this.xrTableCell17.Padding = new PaddingInfo(0, 5, 0, 0, 100f);
    ...
    this.xrTableCell12.Padding = new PaddingInfo(5, 0, 0, 0, 100f);
    ...
    this.xrTableCell13.Padding = new PaddingInfo(0, 5, 0, 0, 100f);
