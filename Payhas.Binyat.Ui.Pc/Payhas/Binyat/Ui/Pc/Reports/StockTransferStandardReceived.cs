...
// Type: Payhas.Binyat.Ui.Pc.Reports.StockTransferStandardReceived
...
public class StockTransferStandardReceived : XtraReport
{
  ...
  public StockTransferStandardReceived() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (StockTransferStandardReceived));
    ...
    this.xrTableCell4.Padding = new PaddingInfo(0, 0, 0, 0, 100f);
    ...
    this.xrTableCell18.Padding = new PaddingInfo(0, 5, 0, 0, 100f);
    ...
    this.xrTableCell14.Padding = new PaddingInfo(0, 5, 0, 0, 100f);
