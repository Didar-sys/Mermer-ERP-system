...
// Type: Payhas.Binyat.Ui.Pc.Reports.StockSlipStandard
...
public class StockSlipStandard : XtraReport
{
  ...
  public StockSlipStandard() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (StockSlipStandard));
    ...
    this.objectDataSource1.DataSource = (object) typeof (StockSlipReport);
