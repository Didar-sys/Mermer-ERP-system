...
// Type: Payhas.Binyat.Ui.Pc.Reports.StockOrderStandard
...
public class StockOrderStandard : XtraReport
{
  ...
  public StockOrderStandard() => this.InitializeComponent();
  ...
  private void InitializeComponent()
  {
    ...
    ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (StockOrderStandard));
    ...
    this.objectDataSource1.DataSource = (object) typeof (StockOrderReport);
