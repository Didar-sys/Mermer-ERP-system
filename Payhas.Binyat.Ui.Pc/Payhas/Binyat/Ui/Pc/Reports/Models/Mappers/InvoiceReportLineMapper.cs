...
// Type: Payhas.Binyat.Ui.Pc.Reports.Models.Mappers.InvoiceReportLineMapper
...
public class InvoiceReportLineMapper(NameHelper nameHelper) : 
  StockTransactionReportLineMapper<InvoiceLine, InvoiceReportLine>(nameHelper)
{
}
