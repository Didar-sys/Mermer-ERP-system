...
// Type: Payhas.Binyat.Ui.Pc.Views.Warehousing.StockTransferDetailsView
...
#nullable disable
namespace Payhas.Binyat.Ui.Pc.Views.Warehousing;

public class StockTransferDetailsView : MvxWpfView, IComponentConnector
{
  internal StockLookupEdit FirstFocus;
  private bool _contentLoaded;

  public StockTransferDetailsView() => this.InitializeComponent();

  private void DetectShortCut(object sender, KeyEventArgs e)
  {
    if (!(this.DataContext is StockTransferDetailsViewModel dataContext))
      return;
    switch (e.Key)
    {
      case Key.Insert:
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/Payhas.Binyat.Ui.Pc;component/views/warehousing/stocktransferdetailsview.xaml", UriKind.Relative));
  }
