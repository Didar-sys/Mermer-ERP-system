...
// Type: Payhas.Binyat.Ui.Pc.Services.UserInteractionService
...
public class UserInteractionService : IUserInteractionService
{
  ...
  private void GetMessage(StringBuilder sb, Exception exception)
  {
    if (exception == null)
      return;
    if (exception.Message != "Exception of type 'Payhas.Binyat.Common.Exceptions.AuthorizationFailedException' was thrown.")
