...
// Type: Mermer.Commerce.Models.Invoice
    ...
    set
    {
      if (this._payments != null)
      {
        ...
        foreach (InvoicePayment payment in (Collection<InvoicePayment>) this._payments)
        {
          ...
          payment.CurrencyConverterRequested -= new Mermer.Transactions.Models.CurrencyConverter(((Transaction<InvoiceLine>) this).CurrencyConverter);
    ...
    set
    {
      if (this._changes != null)
      {
        ...
        foreach (InvoicePayment change in (Collection<InvoicePayment>) this._changes)
        {
          ...
          change.CurrencyConverterRequested -= new Mermer.Transactions.Models.CurrencyConverter(((Transaction<InvoiceLine>) this).CurrencyConverter);
  ...
  private void Payments_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
  {
    if (e.OldItems != null)
    {
      foreach (InvoicePayment invoicePayment in e.OldItems.Cast<InvoicePayment>())
      {
        ...
        invoicePayment.CurrencyConverterRequested -= new Mermer.Transactions.Models.CurrencyConverter(((Transaction<InvoiceLine>) this).CurrencyConverter);
