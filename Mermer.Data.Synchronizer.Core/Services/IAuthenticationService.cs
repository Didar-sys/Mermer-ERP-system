...
// Type: Mermer.Data.Synchronizer.Core.Services.IAuthenticationService
...
{
  Task ValidateUserAsync(string id, bool isAdmin);

  Task<AuthenticatedUser> GetAuthenticatedUserAsync();

  Task<AuthenticatedUser> AuthorizeUserAsync(AuthenticationRequest request);
}
