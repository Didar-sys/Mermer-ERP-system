...
// Type: Payhas.Binyat.CRM.Models.PartnerTransferLine
...
public class PartnerTransferLine : BindableObject
{
  private string _id;
  ...
  public PartnerTransferLine() => this.Id = Guid.NewGuid().ToString();
