...
// Type: Payhas.Binyat.Transactions.Models.TransactionLine
...
public abstract class TransactionLine : BindableObject, IRequestCurrencyConverter
{
  ...
  public event Payhas.Binyat.Transactions.Models.CurrencyId DisplayCurrencyIdRequested;

  protected string GetDisplayCurrencyId()
  {
    Payhas.Binyat.Transactions.Models.CurrencyId currencyIdRequested = this.DisplayCurrencyIdRequested;
  ...
  public event Payhas.Binyat.Transactions.Models.CurrencyId DefaultCurrencyIdRequested;

  protected string GetDefaultCurrencyId()
  {
    Payhas.Binyat.Transactions.Models.CurrencyId currencyIdRequested = this.DefaultCurrencyIdRequested;
    return currencyIdRequested == null ? (string) null : currencyIdRequested();
  }
